<template>
	<div class="flex flex-col bg-surface-white rounded mt-5 overflow-auto" v-if="props.items?.length">
		<div
		...
		>
			<Button
				variant="ghost"
				@click="navigate"
				class="w-full !text-ink-gray-5 py-6 text-sm border-none bg-surface-white hover:bg-surface-white"
			>
				{{ __("View List") }}
			</Button>
		</router-link>
