	...
	<BaseLayout pageTitle="Attendance">
		<template #body>
			<div class="flex flex-col mt-7 mb-7 p-4 gap-7">
				...
				<div>
					<div class="text-lg text-ink-gray-8 font-bold">{{ __("Recent Attendance Requests") }}</div>
					<RequestList
				...
				<div>
					<div class="text-lg text-ink-gray-8 font-bold">{{ __("Upcoming Shifts") }}</div>
					<RequestList
				...
				<div>
					<div class="text-lg text-ink-gray-8 font-bold">{{ __("Recent Shift Requests") }}</div>
					<RequestList
