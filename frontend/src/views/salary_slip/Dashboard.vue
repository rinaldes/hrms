	...
	<BaseLayout :pageTitle="__('Salary Slips')">
		<template #body>
			<div class="flex flex-col items-center my-7 p-4">
				<div class="flex flex-col w-full bg-surface-white rounded py-5 px-3.5 gap-5">
					<div v-if="lastSalarySlip && lastSalarySlip.year_to_date" class="flex flex-col w-full gap-1.5">
						...
						<span class="text-ink-gray-8 text-xl font-bold leading-6">
							{{
								formatCurrency(
				...
				<div class="flex flex-col items-center mt-5 mb-7 w-full">
					<div
						...
						class="flex flex-col bg-surface-white rounded mt-5 overflow-auto w-full"
					>
						<div
